...
const SURVEY_QUESTIONS: any[] = [
  ...
  { id:"familiar_game_desc", q:"What was it? Which enemy, skill, or moment?", type:"text", required:false, condition: (a: any) => a.played_game === "Yes", placeholder:"It was..." },
  { id:"recognize_stressors", q:"Has anything like what happened to Aaron ever happened to you? The pile-on, the losing it, feeling like you can't talk to anyone?", type:"scale", required:false, labels:["Nope","Maybe a little","Some of it","A lot of it","Pretty much all of it"] },
  { id:"what_connected", q:"Which part hit closest to home?", type:"text", required:false, placeholder:"I felt..." },
  { id:"learn_skills", q:"Did the film or game give you anything you could actually use — like a real move for when things get bad?", type:"scale", required:false, labels:["Not really","Maybe one thing","A couple things","Yeah, a few","Yeah, definitely"] },
  { id:"what_learned", q:"What was it? And when do you think you'd actually use it?", type:"text", required:false, placeholder:"I'd use it when..." },
  ...
  { id:"recommend_film", q:"Would you tell a friend to watch Release the Beast?", type:"dropdown", required:false, condition: (a: any) => a.watched_film === "Yes", options:["Yeah","Nah"] },
  ...
  { id:"recommend_game", q:"Would you tell a friend to play Rage Fighters?", type:"dropdown", required:false, condition: (a: any) => a.played_game === "Yes", options:["Yeah","Nah"] },
  { id:"recommend_game_why", q:"Why?", type:"text", required:false, condition: (a: any) => a.played_game === "Yes", placeholder:"Because..." },
